...
def _answer_hook(indent: str) -> str:
    return _make_hook(
        ...
        [
            ...
            "    if text and _run_still_current() and on_answer_delta(message_id=(event_message_id or event.message_id), text=text):",
            "        return",
            "except Exception:",
            "    pass",
        ],
...
def _thinking_hook(indent: str) -> str:
    return _make_hook(
        ...
        [
            ...
            "            and on_thinking_delta(message_id=(event_message_id or event.message_id), text=text)):",
            "        return",
            "except Exception:",
            "    pass",
        ],
...
def _reasoning_hook(indent: str) -> str:
    return _make_hook(
        ...
        [
            ...
            "            on_reasoning_delta(message_id=(event_message_id or event.message_id), text=text)",
            "        except Exception:",
            "            pass",
